...
RSpec.describe "UtilityProviders", type: :request do
  ...
  describe "GET /settings/properties/:property_setting_id/utility_providers/new" do
    it "renders the new template" do
      get new_property_setting_utility_provider_path(property)
  ...
  describe "POST /settings/properties/:property_setting_id/utility_providers" do
  ...
  describe "GET /settings/properties/:property_setting_id/utility_providers/:id" do
    ...
    it "renders the show template" do
      get property_setting_utility_provider_path(property, utility_provider)
      expect(response).to have_http_status(:success)
    end
  ...
  describe "GET /settings/properties/:property_setting_id/utility_providers/:id/edit" do
    ...
    it "renders the edit template" do
      get edit_property_setting_utility_provider_path(property, utility_provider)
      expect(response).to have_http_status(:success)
    end
  ...
  describe "DELETE /settings/properties/:property_setting_id/utility_providers/:id" do
    ...
    it "destroys the utility provider" do
      expect {
        delete property_setting_utility_provider_path(property, utility_provider)
      }.to change(UtilityProvider, :count).by(-1)
    end
